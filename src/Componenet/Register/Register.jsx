...
const Register = () => {
    ...
    return (
        <div>
            <h1 className='text-5xl mt-24 text-red-500'>Please Register</h1>
            <form onSubmit={handleRegistation} className="max-w-sm mx-auto mt-6">
            <div className="mb-5">
                    <input type="text" name='text' id="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" First Name" required />
                </div>
            <div className="mb-5">
